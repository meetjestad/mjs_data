...
set output "../png/mjs_mjsV1_0641_th_02w.png"
set xdata time
...
plot \
   "< cat ../lst/mjs_mjsV1_0641_th_02w.lst"   using 1:($4)  title '          humidity >'  axis x1y2  lt 2  lw 2  lc rgbcolor '#0000FF', \
   "< cat ../lst/mjs_mjsV1_0641_th_02w.lst"   using 1:($3)  title '< temperature       '  axis x1y1  lt 1  lw 2  lc rgbcolor '#FF0000', \
