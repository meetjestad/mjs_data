...
set output "../png/mjs_boom_0081_t_02w.png"
set xdata time
...
plot \
   "< cat ../../knmi/lst/knmi_thdrs_02w.lst"  using 1:('?')  title ''                 axis x1y2  w lp  lw 0   lc rgbcolor '#FFFFFF'  dt 1  pt 3, \
   "< cat ../lst/mjs_boom_0081_ca_02w.lst"    using 1:($3)   title '< temperature  '  axis x1y1  w lp  lw 3   lc rgbcolor '#FF0000'  dt 1  pt 3, \
