...
$sRawFile = sprintf("../lst/mjs_bodem_%04d_%s.lst", $iStation_id, $sPer);
...
$sCapFile = sprintf("../lst/mjs_bodem_%04d_c_%s.lst", $iStation_id, $sPer);
$fpCap = fopen($sCapFile, "w");
if ($fpCap == null) {
    exit("cannot write $sCapFile, abort\n");
}

$sTempFile = sprintf("../lst/mjs_bodem_%04d_t_%s.lst", $iStation_id, $sPer);
