...
set output "../png/mjs_bodem_2021_t_04d.png"
set xdata time
...
plot \
   ...
   "< cat ../lst/mjs_bodem_2021_ca_04d.lst"   using 1:($5)  title 'Temp 10 cm >'          axis x1y2  w lp  lw 5   lc rgbcolor '#DF0000'  dt 1  pt 3, \
   "< cat ../lst/mjs_bodem_2021_ca_04d.lst"   using 1:($7)  title 'Temp 40 cm >'          axis x1y2  w lp  lw 4   lc rgbcolor '#9F0000'  dt 1  pt 3, \
