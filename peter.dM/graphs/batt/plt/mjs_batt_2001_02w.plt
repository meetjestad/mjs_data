...
plot \
   ...
   "< cat ../lst/mjs_batt_2001_02w.lst"       using 1:($2)  title 'battery      '  axis x1y1  w lp  lw 3  lc rgbcolor '#007F00'   dt 1  pt 3, \
   "< cat ../lst/mjs_batt_2001_02w.lst"       using 1:($3)  title 'supply       '  axis x1y1  w lp  lw 3  lc rgbcolor '#007F00'   dt 1  pt 3
