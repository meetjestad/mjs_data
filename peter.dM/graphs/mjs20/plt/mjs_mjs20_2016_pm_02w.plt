...
plot \
   "< cat ../lst/mjs_mjs20_2016_pm_02w.lst"  using 1:($6-$5)/10  title '< pm10. only >'  lt 1  lw 5  lc rgbcolor '#BFBFBF', \
   "< cat ../lst/mjs_mjs20_2016_pm_02w.lst"  using 1:($5-$4)/10  title '< pm4.0 only >'  lt 1  lw 4  lc rgbcolor '#9F9F9F', \
   "< cat ../lst/mjs_mjs20_2016_pm_02w.lst"  using 1:($4-$3)/10  title '< pm2.5 only >'  lt 1  lw 3  lc rgbcolor '#7F7F7F', \
   "< cat ../lst/mjs_mjs20_2016_pm_02w.lst"  using 1:($3/10)     title '< pm1.0 only >'  lt 1  lw 2  lc rgbcolor '#1F1F1F'
