...
set output "../png/mjs_mjs20_2013_th_02w.png"
set xdata time
...
plot \
   ...
   "< cat ../lst/mjs_mjs20_2013_th_02w.lst"   using 1:($3)  title '< temperature       '  axis x1y1  lt 1  lw 2  lc rgbcolor '#FF0000', \
   "< cat ../lst/mjs_mjs20_2013_th_02w.lst"   using 1:($4)  title '          humidity >'  axis x1y2  lt 2  lw 2  lc rgbcolor '#0000FF'
