...
REV=`echo $IK | awk -F_ '{ printf("%s_%sR_%s_%s.lst", $2, $3, $4, $5) }'`
...
echo '# Local-timestamp	Temperature	Rel.Humidity	DewTemperature	Rainfall	RainfallDecayed	Solar-radiation'  > ../../knmi/lst/$LST
echo $SQL | mysql -N -u$DBUSER -D$DBASE -p$DBPASS | awk '{ printf("%s.%s %.1f %.0f %.1f %.1f %.2f %.0f\n", $1, $2, $3, $4, $5, $6, $7, $8) }' >> ../../knmi/lst/$LST
sort -r ../../knmi/lst/$LST | tr ' ' '	' > ../../knmi/lst/$REV
ls -l ../../knmi/lst/$LST
ls -l ../../knmi/lst/$REV
