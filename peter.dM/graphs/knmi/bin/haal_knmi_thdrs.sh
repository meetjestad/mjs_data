# $Id: meetjestad.nl:~meetjestad/.../bin/haal_knmi_thdrs.sh $
# author: Peter Demmer
...
#START=`date --date='-7 days' '+%Y%m%d01'`
END=`date '+%Y%m%d24'`
URL='http://projects.knmi.nl/klimatologie/uurgegevens/getdata_uur.cgi'
POST="start=$START&end=$END&vars=T:TD:U:RH:Q&stns=260"
echo "URL=$URL "
echo "POST=$POST"
echo "HELEURL=$URL?$POST"
# http://projects.knmi.nl/klimatologie/uurgegevens/getdata_uur.cgi?start=2020121801&end=2020122024&vars=T:TD:U:RH:Q&stns=260"
