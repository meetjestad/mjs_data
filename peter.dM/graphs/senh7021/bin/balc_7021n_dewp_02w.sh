...
s1.dewp as d1, s2.dewp as d2, s3.dewp as d3, s4.dewp as d4, s5.dewp as d5, s6.dewp as d6, 'NULL'
FROM sens7021 AS s 
...
php ../php/get_senh7021.php $PHYS $PERIODE
#ls -l ../lst/balc_7021n_${PHYS}_${PERIODE}.lst
#echo ""
