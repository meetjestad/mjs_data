...
set output "../png/mjs_greenroof_2031_hu_02y.png"
set xdata time
...
plot \
   ...
   "< cat ../lst/mjs_greenroof_2031_ca_02y.lst"   using 1:($4)  title '        roof humidity % >'  axis x1y2  w lp  lw 1   lc rgbcolor '#007F00'  dt 1  pt 7 ps 0.5
