...
set output "../png/mjs_greenroof_2086_hu_06m.png"
set xdata time
...
plot \
   ...
   "< cat ../lst/mjs_greenroof_2086_ca_06m.lst"    using 1:($4)  title '        roof humidity % >'  axis x1y2  w lp  lw 2   lc rgbcolor '#007F00'  dt 1  pt 7 ps 0.5
