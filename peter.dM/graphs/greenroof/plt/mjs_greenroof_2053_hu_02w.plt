...
set output "../png/mjs_greenroof_2053_hu_02w.png"
set xdata time
...
plot \
   ...
   "< cat ../lst/mjs_greenroof_2053_ca_02w.lst"   using 1:($4)  title '        roof humidity % >'  axis x1y2  w lp  lw 2   lc rgbcolor '#007F00'  dt 1  pt 7 ps 0.5
