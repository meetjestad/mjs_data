...
STARTTIME="2020-03-14 17:00:00";
EINDETIME="2020-03-16 17:00:00";
...
SQL="SELECT ADDTIME(timestamp, '01:00:00'), temperature, humidity, lux, pm2_5, pm10 FROM sensors_measurement \
     WHERE station_id = $PHYS AND timestamp > '$STARTTIME' AND timestamp < '$EINDETIME' AND pm2_5 < 1000. AND pm10 < 1000. \
